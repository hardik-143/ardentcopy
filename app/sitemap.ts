...
import { querySitemapData } from "@/utils/sanity/query";
import type { QuerySitemapDataResult } from "@/utils/sanity/sanity.types";
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const { slugPages, blogPages, careersPages } =
