...
import { documentSlugField, imageWithAltField } from "@studio/schemaTypes/common";
...
export const blog = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "blogContent",
      title: "Content",
      description: "Build your blog post with blocks: headings, text, images, video, callouts, and code",
      group: GROUP.MAIN_CONTENT,
    }),
    defineField({
      name: "richText",
      type: "richText",
      title: "Rich Text (Legacy — migrate to Content)",
      description: "Legacy content field. Data will be migrated to the Content builder above",
      group: GROUP.MAIN_CONTENT,
      deprecated: {
