...
import { buttonsField, iconField } from "@studio/schemaTypes/common";
...
const navbarColumnLink = defineField({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Category",
      description:
        "Optional group label (e.g. Georgia). Links with the same category appear under this non-clickable label in the dropdown.",
    }),
    defineField({
      name: "url",
      type: "customUrl",
...
export const navbar = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "string",
      title: "Phone Number",
      description: "Contact phone number displayed in the navigation",
    }),
    defineField({
      name: "columns",
      type: "array",
