...
const apiVersion = process.env.NEXT_PUBLIC_SANITY_API_VERSION ?? "2025-08-29";
const baseUrl = process.env.NEXT_PUBLIC_BASE_URL ?? "http://localhost:3000";
const studioTitle = process.env.NEXT_PUBLIC_SANITY_STUDIO_TITLE ?? "Studio";
const studioHost = projectId || undefined;

if (studioHost) {
  console.log(`[SanityCLI] INFO: Sanity Studio Host: https://${studioHost}.sanity.studio`);
}
